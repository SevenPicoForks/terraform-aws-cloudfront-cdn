...
resource "aws_cloudfront_distribution" "default" {
  ...
  #checkov:skip=CKV2_AWS_47:skipping 'Ensure AWS CloudFront attached WAFv2 WebACL is configured with AMR for Log4j Vulnerability' is configurable and is managed via `var.web_acl_id`.
  count = module.context.enabled ? 1 : 0
